  ...
  return (
    <div className="">
      <LandingPageInner
        ...
        description=" We optimize the accounts receivable process by creating in-depth visibility, enabling better decisions, improving user experiences, and boosting cash flow for Uk based businesses."
        ...
        description={
          <div className={`space-y-4  ${bodyTextStyles.descriptionLeft}`}>
            <div>
              ...
              past-due invoices for companies across the UK. It is essential
              that CFOs have clear visibility on real-time cash flow forecasts,
              revised credit limit strategies, and their overall cash position
              within the UK's economy.
            </div>
            <div>
              However, many companies find their Accounts Receivable functions
              to be labor-intensive and overly complex, limiting agility in a
              business context. To optimize value, Accounts Receivable teams
              must prioritize functional expertise and analytics automation to
              streamline processes, optimize transactions, and unlock predictive
              insights faster.
            </div>
            <div className="">
