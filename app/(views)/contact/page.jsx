                  ...
                  <ul className="mb-6 md:mb-0 space-y-6 md:space-y-4">
                    <li className="flex items-start space-x-4">
                      ...
                      <div className="ml-4 mb-4">
                        ...
                        <div className="text-white">
                          Level 23, World Trade Center, West Tower, <br />{" "}
                          Echelon Square, Bank of Ceylon Mawatha
                        </div>
                    ...
                    <li className="flex items-start space-x-4">
                      ...
                      <div className="ml-4 mb-4">
                        ...
                        <p className="text-white">Mobile:+94 77 830 0794</p>
                        <p className="text-white">Mail: info@hconnectint.com</p>
                      </div>
                    </li>
                  </ul>
                </div>
