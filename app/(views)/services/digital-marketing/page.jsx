  ...
  return (
    <div className="w-full">
      ...
      <SectionTextRightDesc
        description={
          <>
            We don’t believe in a one-size-fits-all approach—instead, we tailor
            every campaign, to your specific needs, ensuring a personalized,
            results-driven experience. We blend the power of digital tools and
            the art of human creativity to craft a marketing strategy that is
            uniquely aligned with your business’s goals Leveraging data
            analytics, insights, and time-tested strategies, we create
            high-impact digital campaigns that precisely target your audience,
            amplify your brand’s message, and drive real, measurable growth. By
            optimizing your digital marketing efforts through smart resource
            allocation and data-backed decisions, we help you avoid wasted spend
            and maximize your return on investment (ROI). Whether it's social
            media, SEO, paid ads, or content marketing, we ensure that every
            move is strategic, purposeful, and aligned with your long-term.
          </>
        }
        component={
